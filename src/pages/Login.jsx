...
/* Shared decorative orbs for auth pages */
function AuthOrbs() {
  return (
    <>
      <div style={{position:"absolute",width:500,height:500,borderRadius:"50%",top:-150,left:-150,
        background:"radial-gradient(circle,rgba(109,40,217,0.4) 0%,transparent 70%)",
        filter:"blur(60px)",pointerEvents:"none"}}/>
      <div style={{position:"absolute",width:400,height:400,borderRadius:"50%",bottom:-100,right:-100,
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-footer">
          New to Synapse? <Link to="/signup">Create one</Link>
        </p>
      </div>
    </div>
  );
